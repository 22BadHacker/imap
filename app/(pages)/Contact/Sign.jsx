...
const Sign = () => {
  return (
    <div className='max-w-[1450px] z-20 pt-[100px] gap-5  px-5  pb-[120px] mx-auto w-full h-screen grid grid-cols-2'>
     <section class=" bg-transparent sm:py-16 lg:py-24 w-full">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 w-full">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-3xl font-bold leading-tight text-main sm:text-4xl lg:text-5xl">Contact us</h2>
            <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-main">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis.</p>
        </div>

        <div class="w-full  mt-12 overflow-hidden bg-white rounded-md shadow-md lg:mt-20">
