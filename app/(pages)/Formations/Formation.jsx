  ...
  return (
     <div className='w-full container  z-[1] h-auto max-w-[1450px] px-5  sm:pt-[0px] mx-auto grid grid-cols-1 gap-[40px]'>
            ...
            <div id='Programmes' className="w-full h-auto">
             ...
             <div className="hoo w-full   overflow-hidden md:col-span-1 col-span-2  bg-[rgba(242,243,247,0.9)] rounded-sm h-[300px] relative ">
                ...
                <div className="w-full sm:col-span-1 col-span-2 hoo overflow-hidden bg-[rgb(255,175,176,.3)] rounded-sm h-[300px] relative ">
