...
const Formation = () => {
  return (
     <div className='w-full h-auto max-w-[1450px] px-5  sm:pt-[0px] mx-auto grid grid-cols-1 gap-[40px]'>
             ...
             <div className="w-full relative h-screen grid grid-row-[1fr_auto] items-center  py-[100px] gap-20 sm:justify-center text-center">
                ...
                {/* <div className="w-full h-full flex absolute top-0 left-0">
                    ...
                    {
                        [...Array(20)].map((_, i) => <div className="absolute w-full h-full border-r-[.5px] border-black/20  " key={i} />)
                    }
                </div> */}
                  ...
                  <h1 className='sm:text-[60px] text-black mix-blend-difference relative md:top-[110px] font-morir text-[50px] flex text-wrap leading-snug font-bold opacity-90'>Façonnez votre avenir  avec <br /> nos programmes </h1>
            ...
            <div id='Programmes' className="w-full h-auto">
              ...
              <p className='text-[45px] z-[1] relative font-sussi text-black/85 pb-6 pt-10 whitespace-nowrap leading-[1.25]'>Des compétences étendues, <br /> une orientation claire : <br /> les domaines qui nous définissent
             ...
             <div className="hoo w-full  overflow-hidden  bg-[#eff1f5] rounded-sm h-[300px] relative ">

                    <div className="picc mix-blend-darken absolute top-0 left-0 w-full h-full ">
                        <Image src={pics5} alt='Informatique' className='object-cover   z-[1] h-full   absolute scale-[.9] saturate-[1.2] -right-[50px] -rotate-[25deg] -bottom-[55px]   ' />
                    </div>
                ...
                <div className="w-full col-span-2 hoo overflow-hidden bg-[#efefef] rounded-sm h-[300px] relative ">
                    <Image src={pics4} alt='Génie civil' className='picc object-cover saturate-150 mix-blend-multiply scale-[.65]  z-[1] absolute  -bottom-[90px] -right-20  ' />
                ...
                <div className="hoo w-full overflow-hidden bg-[#eeeefb] rounded-sm h-[300px] relative ">
                ...
                <div className="w-full  hoo overflow-hidden bg-[#f2f2f2] rounded-sm h-[300px] relative ">
                ...
                <div className="w-full  hoo overflow-hidden bg-[rgb(255,175,176,.3)] rounded-sm h-[300px] relative ">
                    <Image src={en} alt='Langue Anglaise' className='picc drop-shadow-[2px_2px_10px_rgba(0,0,0,0.2)] object-cover  saturate-[1.2] -rotate-10  scale-[.77] mix-blend-light  z-[1] absolute  -bottom-[5px] w-full -right-[30px]  ' />
                    <Title title='Langue Anglaise'/>                                         
                </div>

                <div className="w-full col-span-2 hoo overflow-hidden bg-[#f2f2f2] rounded-sm h-[300px] relative ">
                    <Image src={log} alt='Logistique Et management' className='picc mix-blend-multiply object-cover saturate-150  scale-[.55]  z-[1] absolute  -bottom-[110px] w-full -right-[120px]  ' />
                    <Title title='Logistique Et management'/> 
                ...
                <div className="w-full col-span-2 hoo overflow-hidden bg-[#ffe8d5] rounded-sm h-[300px] relative ">
                    <Image src={com} alt='Comptabilité' className='picc  object-cover saturate-150  scale-[.65]  z-[1] absolute  -bottom-[100px] w-full -right-[100px]  ' />
                    <Title title='Comptabilité'/> 
                                
                </div>

                <div className="w-full hoo overflow-hidden bg-[#ede9ea] rounded-sm h-[300px] relative ">
                ...
                <div className="w-full hoo overflow-hidden bg-[#edf9ea] rounded-sm h-[300px] relative ">
                    <Image src={gest} alt='Gestion des entreprises' className='picc  object-cover saturate-150  scale-[.78]  z-[1] absolute  -bottom-[10px] w-full -right-10  ' />
