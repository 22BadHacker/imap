        ...
        <div className='w-full  h-auto max-w-[1450px]  px-5 mx-auto grid grid-cols-1 gap-[40px]'>
            ...
            <div className="w-full relative h-auto py-[120px] z-[1]">
                <div className="flex gap-2 flex-col md:pb-[120px] ">
                    ...
                    <h1 className='sm:text-[60px] text-[#1f1f1f] opacity-95 max-w-[750px] font-sans text-[40px] flex text-wrap leading-[1.2] font-bold '>
                ...
                <div className="grid  lg:grid-cols-3 grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3 pt-12 z-20">
