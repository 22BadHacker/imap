  ...
  return (
    <div className='w-full grid grid-cols-1 sm:grid-cols-2 pt-12 gap-[55px]'>
      ...
      {Gallerie.map((item, i) => (
       ...
       viewport={{ once: true, amount: 0.2 }} className="grid  md:last:col-span-1 sm:last:col-span-2  duration-200 ease-in-out bg-white left-0 md:grid-cols-1 grid-cols-1 gap-6 w-full py-12  border-b-[1.5px] border-b-[#e4ebf5]">
          ...
          <div className="flex flex-col justify-between md:gap-6 gap-10 pt-2">
              <p className='md:text-[16.5px] text-[17.5px] font-medium leading-normal font-sans'><CgQuote className='text-[20px] '/> {item.desc} <span className='w-full flex justify-end'><CgQuote className='text-[20px] '/></span></p>
