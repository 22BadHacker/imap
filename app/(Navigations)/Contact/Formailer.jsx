  ...
  return (
    <div id='rejoignez-nous' className='grid grid-cols-1 lg:grid-cols-[.8fr_1fr] gap-20 lg:gap-12 h-auto pt-[40px] w-full relative'>
        <div className="flex flex-col gap-2">
            <p className='uppercase w-fit text-black contact-title opacity-70 pb-2 text-[14.5px] flex gap-1 items-center'> <span className=''>/</span>Inscrivez-vous maintenant</p>
