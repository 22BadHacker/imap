  ...
  return (
    <>
        <div className="w-full relative  h-auto max-w-[1450px] px-5 mx-auto pb-10 pt-[140px]">
            ...
            <div className="w-full z-[1] relative h-auto flex flex-col   gap-[40px]">
                ...
                <div className="flex flex-col  w-full gap-3">
                    ...
                    <h1 className='text-[75px] tracking-wide z-[5] font-[700]  leading-[1] font-sans max-w-[1100px] text-[#1f1f1f] opacity-90'>Chaque talent  mérite d’être  <span className=''>écouté, guidé, révélé</span>.</h1>
                    <h5 className='text-[16px]  opacity-85 font-medium text-[#1f1f1f] max-w-[700px] pt-6'>Chez IMAP, nos formations sont façonnées pour le réel. Ancrées dans la pratique, elles vous préparent aux métiers d’aujourd’hui et de demain — ici comme ailleurs. Parce qu’apprendre, c’est aussi bâtir sa place dans le monde.</h5>
                </div>
