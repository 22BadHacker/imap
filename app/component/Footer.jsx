...
const Footer = () => {
  return (
    <footer className='max-w-[1450px] relative z-10  px-5  pb-[20px] mx-auto w-full h-auto'>
      ...
      <div className="w-full grid grid-cols-1 lg:gap-4 gap-20 lg:grid-cols-2 py-[170px] ">
          <div className="flex flex-col gap-0">
              ...
              <Link className='text-[30px] font-noto_sans font-semibold leading-tight hover:text-main2 duration-200 ease-in-out' href={'/'}>contact.imap@gmail.com</Link>
              <Link className='text-[30px] font-noto_sans font-semibold leading-tight hover:text-main2 duration-200 ease-in-out' href={'/'}>+212 (0)6 042 483 95</Link>
      ...
      <div className="flex lg:flex-row flex-col gap-6  justify-between lg:items-end sm:py-5 py-10 ">
              <Image className='lg:w-[380px] md:w-[500px] pb-2 w-full relative top-[2px]' src={Ima} alt="logo" />
                <p className='text-[#1f1f1f]  cursor-pointer  relative font-medium  lg:text-[14px]'>&copy; 2025 <span className='font-[900]'>IMAP</span> — Institut des Métiers Appliqués Privé.</p>
        </div>
