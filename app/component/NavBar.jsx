        ...
        <nav className='max-w-[1450px]  z-20  px-5  py-[13px] mx-auto w-full h-auto  flex items-center justify-between'>
            ...
            <div className="flex gap-1 items-center">
                ...
                <div className="flex items-center gap-[2px] ">
                    ...
                    <Link className='text-[19px]  px-[27px]  duration-200 hover:text-white  lg:py-[10px] py-[9px] call relative ease-in-out  text-[#2b2e3a] overflow-hidden border-[1px] border-[#e4e6ef]  font-normal  tracking-wide  rounded-full' href={'/sign-up'}>S'inscrire</Link>
