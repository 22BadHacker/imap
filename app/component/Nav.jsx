  ...
  return (
    ...
    <nav className='w-full z-20 relative h-[65px] flex justify-between items-center '>
        <div className='flex z-[5] w-full flex-row-reverse sm:justify-normal sm:flex-row justify-between items-center gap-10 lg:gap-[60px]'>
            <div onClick={()=> setDrop(!drop)} className={`${active} lg:hidden p-[2px] rounded-full menu cursor-pointer md:size-9 size-[38px] flex flex-col gap-2 justify-center items-center `}>
    ...
    {/* <div className="w-[90%] mt-3 absolute left-1/2 -translate-x-1/2 h-[.2px] opacity-20 bg-main"></div> */}
        ...
        {
            drop && (
                <motion.div animate={{opacity:1, filter: 'blur(0px)'}} transition={{ delay:.2,duration: .25, ease: 'easeInOut'}} initial={{opacity: 0, filter: 'blur(10px)'}} className='w-screen sm:hidden flex  absolute h-auto bg-white right-0 top-0 py-10 pt-[80px] left-0'>
                    <div className='flex linkss relative  flex-col gap-2 w-full pt-10 px-5 pr-10'>
                            ...
                            <div className=" gap-10 items-center  flex w-full justify-center pt-10">
                                ...
                                <Link className='font-medium  relative    border-[.5px] border-main rounded-full text-main py-2 px-5  text-[16px]text-main' href='/'>S'inscrire</Link>
