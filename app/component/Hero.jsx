...
const Hero = () => {
  return (
   <div className="w-full relative  h-auto max-w-[1450px] px-5 mx-auto pb-20 pt-[160px]">
            <div className="w-full z-[1] pb-[100px] relative h-auto flex flex-col  items-center gap-[60px]">
                ...
                <div className="flex gap-8 items-center pt-2">
                    ...
                    <Link className='border-main hover:bg-main2 hover:text-white hover:border-main2 duration-200 ease-in-out text-main font-medium font-inter  px-3 border-[1.5px] sm:py-[11px] py-[9px] rounded-full text-[15px] sm:text-[16.5px]' href={'/'}>Nos formations</Link>
