    ...
    <>
       <div className="flex flex-col relative w-full gap-6 md:gap-12 py-20  items-center text-center justify-center  h-auto max-w-[1450px]  px-5 mx-auto ">
        ...
        <div className="absolute left-5 bottom-0 size-6 border-l-[2.5px] border-main border-b-[2.5px]"></div>
          ...
          <p></p>
            <h1 className='font-bold z-[3] text-[48px] sm:text-[50px] md:text-[70px] opacity-90 text-str leading-[1.08] font-sans lg:text-[90px] max-w-[1300px]'>Bien plus qu’un lieu d’apprentissage — une vraie impulsion pour votre avenir.</h1>
            ...
            <Link href={'/Contact/#rejoignez-nous'}  className="size-[182px] md:scale-100 sm:scale-[.9] scale-[.85] z-[5] out bg-transparent backdrop-blur-[2px] bg-black/05 flex justify-center items-center rounded-full border-main2 border-dashed border-[.5px]">
                <MagneticNested/>
              </Link>
