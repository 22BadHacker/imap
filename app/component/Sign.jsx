...
const Sign = () => {
  ...
  return (
    <div  className='w-screen absolute top-0 left-0 h-screen '>
        ...
        <motion.form initial={{opacity:0, filter: 'blur(10px)'}} transition={{duration: .2, ease: 'easeInOut', type: 'tween'}} animate={{opacity: 1, filter: 'blur(0)'}} action="" className="w-[500px] z-30   h-[600px] flex flex-col gap-2 bg-[#f8f9fb]   overflow-hidden absolute right-[155px] top-[90px]">
