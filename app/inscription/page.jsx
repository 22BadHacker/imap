  ...
  return (
    ...
    <>
      ...
      <div className='w-full relative pt-2 gap-8 h-auto overflow-y-scroll flex items-end justify-center bg-[#d3d8e1]  overflow-x-hidden'>
        ...
        <div className="fixed bottom-0 rounded-full right-0 bg-gradient-to-t from-pink-500 to-violet-500 blur-[100px] opacity-40 size-[300px]"></div>
        <div className="fixed top-0 left-0 rounded-full bg-blue-500 blur-[100px] opacity-40 size-[300px]"></div>
